...
# Project Description 📝
BrainVault is a fully functional ed-tech platform that enables users to create, consume, and rate educational content. <br/>
...
| Section                 | Description                                  |
|-------------------------|----------------------------------------------|
| [BrainVault Aim](#brainvault-aim-)        | 📚 Overview of BrainVault's goals            |
...
## System Architecture 🏰
<br/>
☝ The BrainVault ed-tech platform consists of three main components:  <br/>
...
<br/>
Here is a high-level diagram that illustrates the architecture of the BrainVault ed-tech platform:
...
#### The front end of BrainVault has all the necessary pages that an ed-tech platform should have. Some of these pages are: 
...
- **Cloud-based Media Management ☁️ :** BrainVault uses Cloudinary, a cloud-based media management service, to store and manage all media content, including images, videos, and documents.
...
The back-end of BrainVault uses several data models and database schemas to manage data, including:
