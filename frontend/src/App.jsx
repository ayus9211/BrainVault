...
import InstructorEarnings from "./components/core/Dashboard/InstructorEarnings";
        ...
        >
          ...
          {user?.accountType === ACCOUNT_TYPE.STUDENT && (
            <>
              ...
              <Route path="dashboard/purchase-history" element={<EnrolledCourses title="Purchase History" />} />
              <Route path="dashboard/progress" element={<StudentProgressDashboard />} />
            </>
          )}
