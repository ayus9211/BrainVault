...
export default function EnrolledCourses({ title = "Enrolled Courses" }) {
  ...
  return (
    <>
      <div className="text-4xl text-richblack-5 font-boogaloo text-center sm:text-left">{title}</div>
      {
